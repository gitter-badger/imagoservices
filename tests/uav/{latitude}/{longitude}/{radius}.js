...
/**
 * Test for /uav/{latitude}/{longitude}/{radius}
 */
Test('/uav/{latitude}/{longitude}/{radius}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test uav_getByPosition get operation', function (t) {
            Mockgen().requests({
                path: '/uav/{latitude}/{longitude}/{radius}',
                operation: 'get'
            }, function (err, mock) {
                let request;
                t.error(err);
                ...
                request.end(function (err, res) {
                    ...
                    let validate = Validator(api.paths['/uav/{latitude}/{longitude}/{radius}']['get']['responses']['200']['schema']);
